...
export const areas: SmartOfficeArea[] = [
  { id: 1, name: 'Main Entrance', occupancy: 0, status: 'Active' },
  { id: 2, name: 'Company A', occupancy: 1, status: 'Active' },
  { id: 3, name: 'Company B', occupancy: 1, status: 'Active' },
  { id: 4, name: 'Server Room', occupancy: 1, status: 'Active' },
  { id: 5, name: 'Management / Admin', occupancy: 1, status: 'Active' },
  { id: 6, name: 'Company C', occupancy: 1, status: 'Active' },
  { id: 7, name: 'Company D', occupancy: 0, status: 'Active' },
];
